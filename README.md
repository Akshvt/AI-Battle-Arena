...
- **Fighter B (Google Gemini)**: Powered by `gemini-3-flash-preview`. Google's ultra-fast, 15 RPM free-tier model perfectly matched against Mistral for speed and logic.
